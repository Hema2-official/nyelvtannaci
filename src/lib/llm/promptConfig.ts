...
export const developerPrompt = [
	...
	[
		...
		`The tools are a strong signal, not an oracle, and you are responsible for the final answer.
		 ...
		 - Behind that question is the measurement of step 6, and the -i képző counts towards the syllables. An -i adjective is a syllable longer than the noun it comes from, so it can need the hyphen where that noun does not: "élelmiszeripar" stays solid at six syllables, "élelmiszer-ipari" takes the hyphen at seven. Measure the exact form you are going to write, never a related one.
